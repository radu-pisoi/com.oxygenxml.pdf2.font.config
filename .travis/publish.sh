...
echo "====================================="
sh dita-ot-2.4/bin/dita -i "DITA sample/font-configuration.ditamap" -f pdf2 -output=publishing -v  -Dorg.dita.pdf2.i18n.enabled=false -Dclean.temp=no -temp=temp_dir
